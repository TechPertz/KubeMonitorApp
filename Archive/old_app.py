...
# Define your Flask app routes and views here

if __name__ == "__main__":
    env = os.environ.get('FLASK_ENV', 'development')
    port = int(os.environ.get('PORT', 5000))
    debug = env != 'production'  # Debug mode is True unless FLASK_ENV is 'production'
    
    # Ensure the app listens on all interfaces and uses the specified port and debug settings
